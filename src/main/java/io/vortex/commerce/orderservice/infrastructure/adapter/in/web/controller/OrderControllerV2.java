...
public class OrderControllerV2 {
    ...
    private final CancelOrderUseCase cancelOrderUseCase; // <-- Nuevo
    ...
    public ResponseEntity<OrderResponse> cancelOrder(@PathVariable Long orderId) {
        var cancelledOrder = cancelOrderUseCase.cancelOrder(orderId);
        var response = mapper.toResponse(cancelledOrder);
        return ResponseEntity.ok(response);
    }
}